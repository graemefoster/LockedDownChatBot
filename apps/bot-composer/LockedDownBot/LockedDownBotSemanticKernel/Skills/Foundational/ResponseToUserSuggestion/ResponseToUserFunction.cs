...
public abstract class ResponseToUserFunction<TRequest, TResponse> : SemanticKernelFunction<TRequest, TResponse> where TRequest : notnull where TResponse : notnull
{
